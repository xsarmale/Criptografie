...
namespace Laborator_1
{
    class Program
    {
        ...
        {
            TextReader dataLoad = new StreamReader(@"C:\Users\boral\source\repos\Laborator 1\Laborator 1\Text.txt");
            string s = dataLoad.ReadLine();
            Console.WriteLine("Your text is: " + s);
            dataLoad = new StreamReader(@"C:\Users\boral\source\repos\Laborator 1\Laborator 1\Source.txt");
            ...
            TextWriter data = new StreamWriter(@"C:\Users\boral\source\repos\Laborator 1\Laborator 1\Solution.txt");
            data.WriteLine(sol);
